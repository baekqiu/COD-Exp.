...
parser.add_argument('--model_path', type=str,
                default='/home/kai/Desktop/xxq/SINet-master/Snapshot/7/7_smimedge/SINet_120.pth')
parser.add_argument('--test_save_res2', type=str,
                    default='./Result/7_9/res2/')
parser.add_argument('--test_save_edge', type=str,
                    default='./Result/7_9/edge/')
parser.add_argument('--test_save_res1', type=str,
                    default='./Result/7_9/res1/')
...
for dataset in ['CHAMELEON']:
    ...
    for iteration in range(test_loader.size):
        ...
        # coarse score
        data = open("/home/kai/Desktop/xxq/SINet-master/7_9test.txt","a")
