...
__all__ = ['Res2Net', 'res2net50', 'res2net50_26w_4s', 'res2net50_48w_2s', 'res2net50_14w_8s', 
...
def res2net50(pretrained=False, **kwargs):
    ...
    if pretrained:
        pretrained_dict = model.load_state_dict(model_zoo.load_url(model_urls['res2net50_26w_4s']))
    return model
