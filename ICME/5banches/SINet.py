...
class PDC_SM(nn.Module):
    ...
    def __init__(self, channel):
        ...
        self.conv_inception1 = BasicConv2d(6*channel,48,1,padding=0)
        self.conv_inception2_1 = BasicConv2d(6*channel,3*channel,1,padding=0)
        self.conv_inception2_2 = BasicConv2d(3*channel,48,3,padding=1)
        self.conv_inception3_1 = BasicConv2d(6*channel,48,1,padding=1)
        self.conv_inception3_2 = BasicConv2d(48,48,5,padding=1)
        self.conv_inception4_1 = nn.MaxPool2d(3,stride=1,padding=1)
        self.conv_inception4_2 = BasicConv2d(6*channel,channel,1,padding=0)
        self.conv5 = nn.Conv2d(176, 1, 1)
    ...
    def forward(self, x1, x2, x3, x4, x5):
        ...
        x4_1 = self.conv_upsample6(self.upsample(x2)) * x3 * x4

        x2_2 = torch.cat((x2_1, self.conv_upsample4(self.upsample(x1_1))), 1)
        x2_2 = self.conv_concat2(x2_2)

        x3_2 = torch.cat((x3_1, self.conv_upsample7(self.upsample(x2))), 1)

        x4_2 = torch.cat((x4_1, self.conv_upsample5(self.upsample(x2_2)), x3_2, x5),1)
        #print(x3_2.shape)
        x5_1 = self.conv_inception1(x4_2)
        x5_2 = self.conv_inception2_2(self.conv_inception2_1(x4_2))
        x5_3 = self.conv_inception3_2(self.conv_inception3_1(x4_2))
        x5_4 = self.conv_inception4_2(self.conv_inception4_1(x4_2))
        '''print(x5_1.shape)
        print(x5_2.shape)
        print(x5_3.shape)
        print(x5_4.shape)'''
...
class PDC_IM(nn.Module):
    ...
    def __init__(self, channel):
        ...
        self.conv_upsample4 = BasicConv2d(channel, channel, 3, padding=1)
        self.conv_upsample5 = BasicConv2d(2*channel, 2*channel, 3, padding=1)
        self.conv1_inception1 = BasicConv2d(96,24,1,padding=0)
        self.conv1_inception2_1 = BasicConv2d(96,48,1,padding=0)
        self.conv1_inception2_2 = BasicConv2d(48,24,3,padding=1)
        self.conv1_inception3_1 = BasicConv2d(96,24,1,padding=1)
        self.conv1_inception3_2 = BasicConv2d(24,24,5,padding=1)
        self.conv1_inception4_1 = nn.MaxPool2d(3,stride=1,padding=1)
        self.conv1_inception4_2 = BasicConv2d(96,24,1,padding=0)
    ...
    def forward(self, x1, x2, x3):
        ...
        x6_1 = self.conv1_inception1(x3_2)
        x6_2 = self.conv1_inception2_2(self.conv1_inception2_1(x3_2))
        x6_3 = self.conv1_inception3_2(self.conv1_inception3_1(x3_2))
        x6_4 = self.conv1_inception4_2(self.conv1_inception4_1(x3_2))

        #x3_2 = self.conv_concat3(x3_2)
        #x = self.conv4(x3_2)
        #print(x.shape)
        x = torch.cat((x6_1,x6_2,x6_3,x6_4),1)
        x = self.conv5(x)
...
class SINet_ResNet50(nn.Module):
    ...
    def __init__(self, channel=32, opt=None):
        ...
        self.rf0_sm = RF(64, channel) 
        self.rf1_sm = RF(64, channel)
        self.rf2_sm = RF(64, channel)
        self.rf3_sm = RF(64, channel)
    ...
    def forward(self, x):
        ...
        x0_down = self.downSample(x0)         # (BS, 320, 44, 44)
        x0_sm_rf = self.rf0_sm(x0_down)    # (BS, 32, 44, 44)
        ...
        x1_sm_rf = self.rf1_sm(x1_down)
        x2_sm_rf = self.rf2_sm(x2)
        x3_sm_rf = self.rf3_sm(x3_sm)
        x4_sm_rf = self.rf4_sm(x4_sm)
        camouflage_map_sm = self.pdc_sm(x4_sm_rf, x3_sm_rf, x2_sm_rf, x1_sm_rf, x0_sm_rf)
