...
from Src.utils.dataloader1 import get_loader
from Src.utils.boundarytrainer import boundarytrainer, adjust_lr
...
if __name__ == "__main__":
    ...
    parser.add_argument('--save_model', type=str, default='./Snapshot/iccv-vspw/')
    parser.add_argument('--train_img_dir', type=str, default='/home/kai/Desktop/vspw/VSPW_480p/traindata/origin/')
    parser.add_argument('--train_edge_dir', type=str, default='/home/kai/Desktop/vspw/VSPW_480p/traindata/edge/') 
    parser.add_argument('--data_dir', type=str, default='/home/kai/Desktop/vspw/VSPW_480p/')
    ...
    model_Boundary = Boundarydetection().cuda()
    #model_Boundary.load_state_dict(torch.load('/home/kai/Desktop/xxq/SINet-master/Snapshot/boundaryextend/BoundaryNet_24.pth'))
    ...
    train_loader = get_loader(opt.data_dir, opt.train_edge_dir, batchsize=opt.batchsize,
