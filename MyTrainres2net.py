...
from Src.utils.trainer1 import trainer, adjust_lr
...
if __name__ == "__main__":
    ...
    parser.add_argument('--save_model', type=str, default='./Snapshot/7/7SMIMRESNET/')
    ...
    model_SINet = SINet_Res2Net50(channel=32).cuda()
    ...
    plt.savefig('./7_7SMIMRESNETlr.jpg')
    plt.show()
